<template>
  <div class="pernewpsw">
    ...
    <div class="newpswBox">
      ...
      <div class="newpswspan">{{pernewpswspan}}</div>
      ...
      <div class="newpswspan">{{twicepswspan}}</div>
      <div class="btns">
        <button @click="pernewpswnext()">下一步</button>
        <button @click="pernewpswback()">返回</button>
      </div>
    </div>
    <!-- input框end -->
  </div>
  ...
  methods: {
    ...
    pernewpswnext(){
      if (
        ...
        this.$router.push("/signup/perforfinish");
        //发送请求
      }
    },
  },
